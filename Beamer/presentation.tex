        ...
        \subsection{Stable Frobenius categories}
            ...
            \begin{frame}{Triangulation}
                ...
                \begin{onlyenv}<3>
                    ...
                    \begin{flushleft}
                        \begin{tikzcd}[ampersand replacement=\&]
                            \Omega Z \ar[two heads]{r}{-\Omega z}[marking]{\circ} \ar[phantom]{rd}[very near start]{\ulcorner} \ar[tail]{d}{i}[marking]{\circ} \& X \ar[tail]{d}{x}[marking]{\circ} \ar[bend left]{rdd}{0}\\
                            P(Z) \ar[bend right, two heads]{rrd}{p}[marking]{\circ} \ar[two heads]{r}{p'}[marking]{\circ} \& Y \ar[dashed, two heads]{dr}{y}[marking]{\circ} \\
                            \& \& Z
                        \end{tikzcd}
                        $\impliedby$
                        \begin{tikzcd}[ampersand replacement=\&]
            ...
            \begin{frame}{Homotopy categories are triangulated}
                ...
                \begin{onlyenv}<2>
                    ...
                    \begin{lemma}[Triangulation on $K(\mathcal{A})$]
                        ...
                        \begin{center}
                            \begin{tikzcd}[ampersand replacement=\&]
                                \chain{A} \ar{r}{\chain{r}} \& \chain{B} \ar{r} \& cone(\chain{r}) \ar{r} \& \chain{A}[1]
                            \end{tikzcd}
                        \end{center}
                    \end{lemma}
                \end{onlyenv}
