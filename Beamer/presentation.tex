    ...
    \section{Frobenius Categories}
        ...
        \subsection{Stable Frobenius categories}
                ...
                \begin{onlyenv}<2>
                    ...
                    \begin{lemma}
                        ...
                        \begin{center}
                            \begin{tikzcd}[ampersand replacement=\&]
                                \& I \\
                                A \ar[dashed]{ur}[above]{f'} \& B \ar[tail]{l}[below]{p}[marking]{\circ} \ar{u}{f}
                            \end{tikzcd}
                        \end{center}
                    \end{lemma}
                \end{onlyenv}
            ...
            \begin{frame}{Cosyzygies and stabilization}
                ...
                \end{onlyenv}
                \begin{onlyenv}<3->
                    \begin{definition}[Frobenius category]
            ...
            \begin{frame}{Triangulation}
                \begin{itemize}
                    \item $\underline{\mathcal{A}}$ is an additive category
                    \item \upside{$\Omega$}$:\underline{\mathcal{A}}\rightarrow\underline{\mathcal{A}}$ is an additive autoequivalence
                    \item<1> What is $\Delta_{\underline{\mathcal{A}}}$?
                \end{itemize}
                \begin{onlyenv}<2>
                    \underbar{Triangles from morphisms}
                    \begin{flushleft}
                        \begin{tikzcd}[ampersand replacement=\&]
                            X \ar{r}{x} \& Y
                        \end{tikzcd}
                        ...
                        \begin{tikzcd}[ampersand replacement=\&]
                            ...
                            I(X) \ar[bend right, two heads]{rrd}{p}[marking]{\circ} \ar{r}{p'} \& Z \ar[dashed, two heads]{dr}{z}[marking]{\circ} \\
                            \& \& \rotatebox[origin=c]{180}{$\Omega$}X
                        \end{tikzcd}
                    \end{flushleft}
                \end{onlyenv}
                \begin{onlyenv}<3>
                    \underbar{Triangles from conflations}
                    \begin{flushleft}
                        \begin{tikzcd}[ampersand replacement=\&]
                            \Omega Z \ar{r}{-\Omega z} \ar[phantom]{rd}[very near end]{\lrcorner} \ar[tail]{d}{i}[marking]{\circ} \& X \ar[tail]{d}{x}[marking]{\circ} \ar[bend left]{rdd}{0}\\
                            P(Z) \ar[bend right, two heads]{rrd}{p}[marking]{\circ} \ar{r}{p'} \& Y \ar[dashed, two heads]{dr}{y}[marking]{\circ} \\
                            \& \& Z
                        \end{tikzcd}
                        $\impliedby$
                        \begin{tikzcd}[ampersand replacement=\&]
                            X \ar[tail]{d}{x}[marking]{\circ} \\
                            Y \ar[two heads]{d}{y}[marking]{\circ} \\
                            Z
                        \end{tikzcd}
                    \end{flushleft}
                \end{onlyenv}
        ...
        \subsection{Homotopy categories}
            \begin{frame}{Homotopy categories are triangulated}
                ...
                \begin{onlyenv}<3>
                    ...
                    \end{definition}
                    \begin{lemma}[Exact structure on $Ch(\mathcal{A})$]
                ...
                \begin{onlyenv}<4>
                    \begin{definition}[Homotopy category]
                        $K(\mathcal{A})=Ch(\mathcal{A})/\sim$
                    \end{definition}
                    \begin{lemma}[Triangulation on $K(\mathcal{A})$]
                        For every chain map $\chain{r}:\chain{A}\rightarrow\chain{B}$ there is a triangle as the diagram below.
                        \begin{center}
                            \begin{tikzcd}[ampersand replacement=\&]
                                \chain{A} \ar{r}{\chain{r}} \& \chain{B} \ar[tail]{r}{\begin{pmatrix}1 \\ 0\end{pmatrix}}[marking]{\circ} \& cone(\chain{r}) \ar[two heads]{r}{\begin{pmatrix}0 & \chain{-1}\end{pmatrix}}[marking]{\circ} \& \chain{A}[1]
                            \end{tikzcd}
                        \end{center}
                    \end{lemma}
                \end{onlyenv}
