...
\begin{document}
                ...
                \end{center}
                    ...
                    \begin{center}
                        \begin{tikzcd}
                            ...
                            B' \ar[orange]{rd}[black]{b'} \ar[violet]{r}[black]{\eta '} & E \ar[violet]{r}[black]{\eta ''} \ar[teal]{d}[black]{g'} & TA \ar[red]{d}[black]{Ta} \\
    ...
    \section{Exact Categories}
        ...
        \subsection{The Stable Frobenis Category}
            ...
            \begin{proof}
                Define the category $\mathcal{C}/\sim$ to have the same objects as $\mathcal{C}$, and define $\mathcal{C}/\sim (A,B)=\mathcal{C}(A,B)/\sim_{a,b}$. This definition is well defined as $\sim$ is a congruence relation. A sketch of this proof can be found in \cite{maclane}.
            \end{proof}
            ...
            \begin{proof}
                ...
                \begin{center}
                    \begin{tikzcd}[row sep=tiny]
                        ...
                        \textcolor{white}{.} \\
                        \textcolor{white}{.} \\
                        Y \ar[equal]{rd}[above, pos=0.9]{\alpha (Y)}[below, pos=0.2]{\alpha '(Y)} \ar[tail]{rr}[marking]{\circ}[near start]{j} & & J \ar{rd}[above, pos=0.8]{\beta (Y)} \ar[two heads]{rr}[marking]{\circ}[near start]{q} & & \rotatebox[origin=c]{180}{$\Omega$}Y \ar{rd}[above, pos=0.8]{\gamma (Y)} \\
