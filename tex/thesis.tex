...
\begin{document}
    ...
    \section{Triangulated Categories}
        ...
        \subsection{Calculus of Fractions and Localizations of Triangulated Categories}
            ...
            \begin{proof}
                We are able to find three triangles in $\mathcal{T}$.
                \begin{center}
                    (1)
                    \begin{tikzcd}[row sep=tiny]
                    ...
                    \end{tikzcd}
                \end{center}
                By the Octahedron axiom there exist another triangle in $\mathcal{T}$:
                \begin{center}
                    \begin{tikzcd}
                        Z' \ar[teal]{r} & X' \ar[teal]{r} & Y' \ar[teal]{r} & TZ'
                    \end{tikzcd}
                \end{center}
                Note that $f$ is in $Mor_\mathcal{S}$ if and only if $Z' : S$. WLOG assume that $f$ and $g$ is in $Mor_\mathcal{S}$, this can be done by the rotation axiom. Thus we can find the triangle $(Z',X',Y'')$ in $\mathcal{S}$ proving that $Y'$ is in $\mathcal{S}$ by the following diagram:
                \begin{center}
                    \begin{tikzcd}
