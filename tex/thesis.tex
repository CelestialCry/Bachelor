...
\begin{document}
    ...
    \section{Exact Categories}
        ...
        \subsection{Definitions and First Properties}
            ...
            \begin{theorem}
                Assume that $i:A\rightarrow B$ is a morphism with a cokernel. If there is a morphism $j:B\rightarrow C$ such that $ji$ is an inflation, then $i$ is an inflation.
            \end{theorem}
