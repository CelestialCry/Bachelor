    ...
    \section{Exact Categories}
        ...
        \subsection{Definitions and First Properties}
            ...
            \begin{lemma}
                ...
                \end{tikzcd} such that we have the following diagram.
                \begin{center}
                    \begin{tikzcd}
                        A \ar[tail]{r}{p}[marking]{\circ} \ar[equal]{d} & B \ar[two heads]{r}{q}[marking]{\circ} \ar{d} & C \ar{d} \\
                        A \ar[tail]{r}[marking]{\circ} \ar[two heads]{r}[marking]{\circ} & D & C' \\
                        A' & B' & C'
                    \end{tikzcd}
                \end{center}
            \end{lemma}
