...
\section{Homology and Derived Categories}
    ...
    \begin{proof}
        ...
        These factorizations exists at every index over the chain complexes. In this way one may find the diagram below. Note that two bicartesian squares may be connected to make a bicartesian rectangle.
    ...
    \subsection{Derived Functors}
        ...
        \begin{center}
            \begin{tikzcd}
                ...
                D(\mathcal{A}) \ar[dotted]{r}{?} & D(\mathcal{B})
            \end{tikzcd}
        \end{center}
        ...
        \begin{center}
            \begin{tikzcd}
                \mathcal{T} \ar{r}{F} \ar{d}{q_{\mathcal{M}}} & \mathcal{S} \ar{d}{q_{\mathcal{N}}} \\
                \mathcal{T}/\mathcal{M} \ar[dotted]{r}{?F} & \mathcal{S}/\mathcal{N}
            \end{tikzcd}
            \begin{tikzcd}[column sep=small]
                \mathcal{T} \ar{rd}{q} \ar{rr}{qF} & & \mathcal{S}/\mathcal{N} \\
                & \mathcal{T}/\mathcal{M} \ar[dashed]{ru}{F}
            \end{tikzcd}
        \end{center}
        ...
        \begin{center}
            \begin{tikzcd}
                FA \ar[equal]{r} & FA & A & A \ar[equal]{l}
            \end{tikzcd} $\iff$
            \begin{tikzcd}
                FA \ar{r}{canon} & \mathbb{R}FA
            \end{tikzcd}
        \end{center}
        ...
        \begin{center}
            \begin{tikzcd}
                FC'' & & C''\\
                FC' \ar{u}{Fs'} & C' \ar{ru}{s'} & & A'' \ar{lu}{g'} \\
                B \ar{u}{f} & & A \ar{lu}{g} \ar{ru}{s} & & A' \ar{lu}{t}
            \end{tikzcd}
        \end{center}
