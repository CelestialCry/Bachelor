...
\section{Definition and First Properties}
    ...
    The naming convention of the candidate triangles isn't standardized, some literatures calls the candidate triangles for triangles instead; \todo[color=red]{Fotnote?} see \cite{keller}. This name arises from an alternate description of the diagrams given above. To remove confusion about the domain or codomain of the arrows, one arrow of the triangle is decorated with \todo[color=green]{få fram tydeligere hvordan pilene ser ut} "$_{\Sigma_{\mathcal{T}}}$|". This decorator means that the functor $\Sigma_{\mathcal{T}}$ has to be applied to the corresponding edge of the arrow. With this notation the c arrow points to $\Sigma_{\mathcal{T}}A$, not $A$.
        ...
        \begin{enumerate}
            ...
            \item (TR2) Rotation axiom
                ...
                \begin{center}
                    ...
                    \end{tikzcd} $\implies$
                    \begin{tikzcd}
                        B \arrow{r}{b} & C \arrow{r}{c} & TA \arrow{r}{-\Sigma_{\mathcal{T}}a} & \Sigma_{\mathcal{T}}B
                    \end{tikzcd}
            ...
            \item (TR4) Octahedron axiom
                ...
                \begin{center}
                    \begin{tikzcd}
                        ...
                        & C' \ar{r}{f} \ar{d}{x'} & B' \ar{r}{g} \ar{d}{z'} & A' \ar{r}{\Sigma_{\mathcal{T}}i \circ y'} & \Sigma_{\mathcal{T}}C' \\
    ...
    \begin{remark}
        Some literatures refer to triangulated functors as exact functors. \todo[color = red]{Trenger kilder her}
    \end{remark}
    % Homological functor
    \begin{definition}
    ...
    \begin{proof}
        ...
        \begin{center}
            ...
            \end{tikzcd} $\implies$
            \begin{tikzcd}
                \mathcal{\Sigma_{\mathcal{T}}}(M,\Sigma_{\mathcal{T}}^iA) \ar{r}{\Sigma_{\mathcal{T}}^ia_*} & \mathcal{\Sigma_{\mathcal{T}}}(M,\Sigma_{\mathcal{T}}^iB) \ar{r}{\Sigma_{\mathcal{T}}^ib_*} & \mathcal{\Sigma_{\mathcal{T}}}(M,\Sigma_{\mathcal{T}}^iC)
            \end{tikzcd}
        \end{center}
    ...
    \begin{proof}
        ...
        \begin{center}
            ...
            \begin{tikzcd}[row sep=small, ampersand replacement=\&]
                ...
                C \ar[red, very near end, "|" marking]{uu}[near end]{\Sigma_{\mathcal{T}}}[pos=0.5]{0}
            \end{tikzcd}
            \begin{tikzcd}[row sep=small, ampersand replacement=\&]
                A\oplus B \ar[orange]{rd}{\begin{pmatrix} 1 & 0\end{pmatrix}} \\
                \& A \ar[orange]{ld}{0} \\
                \Sigma_{\mathcal{T}}B \ar[orange, very near end, "|" marking]{uu}[near end]{\Sigma_{\mathcal{T}}}[near start]{\begin{pmatrix}0 \\ 1\end{pmatrix}}
            \end{tikzcd}
            \begin{tikzcd}[row sep=small]
                D \ar[violet]{rd}{f'} \\
                & A \ar[violet]{ld}{} \\
                E \ar[violet, very near end, "|" marking]{uu}[near end]{\Sigma_{\mathcal{T}}}
            \end{tikzcd} \\
            (3)
            \begin{tikzcd}
                \textcolor{white}{.} \\
                C \ar[teal]{r} & E \ar[teal]{r}{} & \Sigma_{\mathcal{T}}B \ar[teal]{r}{} & \Sigma_{\mathcal{T}}C \\
                \textcolor{white}{.}
            \end{tikzcd}
        \end{center}
...
\section{Calculus of Fractions and the Verdier Quotient}
    ...
    \todo[color = pink]{Burde jeg endre på noe her. Kan det være greit å forklare hvorfor de er vanskelig å beskrive?} These categories are in general pretty hard to describe. When the set of morphisms is a multiplicative system, there is a calculus of fractions description of these localization in the same style as for localizations of rings.
    ...
    \begin{definition}
        \todo{Dette må også fikses etter at det over er fikset!!!} A multiplicative system $S$ in a locally small category $\mathcal{C}$ is called locally small on the right if for every object $X:\mathcal{C}$ there is a set $S_X$ of morphisms from $S$ such that for every morphism $f : X_1 \rightarrow X$ in $S$ there is a morphism $f' : X'\rightarrow X$ in $S_X$ factoring thorough $f$.
    ...
    \begin{proof}
        ...
        \begin{center}
            \begin{tikzcd}
                Z \ar{r}{at'} \ar{d}[below, rotate = 90]{\simeq}[near start]{t} & B \ar{r} \ar[equal]{d} & Z' \ar{r} \ar[dashed]{d}[below, rotate = 90]{\simeq} & \Sigma_{\mathcal{C}}Z \ar{d}[below, rotate = 90]{\simeq}[near start]{\Sigma_{\mathcal{C}}t} \\
